    ...
    const fetchData = async () => {
      ...
      try {
        const res = await api.get(
          `/weather?q=${city}&appid=${process.env.REACT_APP_API_KEY}&units=metric`
        );
        setData(res.data);
        ...
        <>
          ...
          <section>
            ...
            <div className="cont_temp">
              <strong className="temp">{parseInt(main.temp)}&deg;</strong>
              <div>
                <span className="temp_max">
                  최대 : {parseInt(main.temp_max)}&deg;
                </span>
                <span className="temp_min">
                  최저 : {parseInt(main.temp_min)}&deg;
                </span>
              </div>
            </div>
          </section>
